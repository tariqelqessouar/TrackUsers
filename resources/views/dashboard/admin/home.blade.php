          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col-6">
                ...
                >
                <h4 class="mb-3">
                  $<span class="counter-value" data-target="945.2"
                    >0</span
                  >k
                </h4>
              </div>
              ...
              <div class="col-sm align-self-center">
                <div class="mt-4 mt-sm-0">
                  <div>
                    <p class="mb-2">
                      <i
                        class="mdi mdi-circle align-middle font-size-10 me-2 text-success"
                      ></i>
                      Bitcoin
                    </p>
                    <h6>
                      ...
                      <tr>
                        <td style="width: 50px">
                          <div class="font-size-22 text-success">
                            <i
                              class="bx bx-down-arrow-circle d-block"
                            ></i>
                          </div>
                        </td>
                      ...
                      <tr>
                        <td>
                          <div class="font-size-22 text-danger">
                            <i
                              class="bx bx-up-arrow-circle d-block"
                            ></i>
                          </div>
                        </td>
                  ...
                  <div class="timeline-list-item">
                    <div class="d-flex">
                      ...
                      <div class="flex-shrink-0 text-end">
                        <div class="dropdown">
                          <a
                            class="text-muted dropdown-toggle font-size-24"
                            role="button"
